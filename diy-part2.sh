...
# 更新指定软件包
./scripts/feeds uninstall alist luci-app-alist frpc luci-app-frpc luci-app-vlmcsd
./scripts/feeds install -p kiddin9 alist luci-app-alist frpc luci-app-frpc luci-app-vlmcsd
